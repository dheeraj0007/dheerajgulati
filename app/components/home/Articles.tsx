...
const Articles = () => {
  return (
    <div className="my-16 bg-black rounded-4xl tracking-tighter flex flex-col justify-center items-center w-full h-full py-6 text-center">
      <h1 className="text-3xl sm:text-4xl text-white ">Liked My work?</h1>
      <p className="text-2xl sm:text-3xl tracking-tight text-gray-200">
